...
class Info(object):
    ...
    def __init__(self, embedding_size, embed_L2_norm):
        assert isinstance(embedding_size, int) and embedding_size > 0   #assert 调试
...
class Model(nn.Module):
    ...
    def predict(self, users_feature, bundles_feature,items_feature, *args, **kwargs):
        '''
    ...
    def regularize(self, users_feature, bundles_feature,items_feature, *args, **kwargs):
        '''
        ...
        return loss        #embed_L2_norm ：相当于 正则项系数 λ    返回的loss就是model_out中的L2_loss
